...
$oRecord->id = "JobModify";
$oRecord->resources[] = $oRecord->id;
$oRecord->title = ffTemplate::_get_word_by_code("recruitment_job_experience_title");
$oRecord->src_table = CM_TABLE_PREFIX . "mod_recruitment_cv_job";
