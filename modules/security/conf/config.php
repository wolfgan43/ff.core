...
if (!defined("MOD_SEC_LOGIN_REGISTER_URL")) define ("MOD_SEC_LOGIN_REGISTER_URL", null);  
...
if (!defined("SECURITY_REGISTER_EMAIL_HOST")) define("SECURITY_REGISTER_EMAIL_HOST", "mail.xoduslab.com");
if (!defined("SECURITY_REGISTER_EMAIL_USER")) define("SECURITY_REGISTER_EMAIL_USER", "mailer@xoduslab.com");
if (!defined("SECURITY_REGISTER_EMAIL_PASS")) define("SECURITY_REGISTER_EMAIL_PASS", "mailxnmer");
if (!defined("SECURITY_REGISTER_EMAIL_FROM")) define("SECURITY_REGISTER_EMAIL_FROM", "supporto@xodusweb.com");
...
if (!defined("MOD_SEC_USER_AVATAR"))		define ("MOD_SEC_USER_AVATAR",		"");
...
if (!defined("MOD_SEC_DEFAULT_FIELDS")) define("MOD_SEC_DEFAULT_FIELDS" , "ID,ID_domains,username,username_slug,password,level,status,expiration,email,time_zone,role,created,password_generated_at,temp_password,password_used,ID_packages,lastlogin" . (strlen(MOD_SEC_USER_AVATAR) ? "," . MOD_SEC_USER_AVATAR : ""));
