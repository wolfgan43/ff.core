...
$oField->multi_pairs = array(
    ...
    , array(new ffData("pills-justified"), new ffData("Pills Justified"))
    , array(new ffData("bordered"), new ffData("Bordered"))
    , array(new ffData("bordered-justified"), new ffData("Bordered Justified"))
    , array(new ffData("left"), new ffData("Left"))
    , array(new ffData("right"), new ffData("Right"))
);
$oField->multi_select_one = false;
$oField->value = new ffData($tab);
$cm->oPage->addContent($oField);

$js = ' 
    jQuery("#tab").change(function() {
    window.location.href="?tab=" + jQuery(this).find(":selected").attr("value");
    });
';

$cm->oPage->tplAddJs("tab", array(
    "embed" => $js
));
 ...
 */
$cm->oPage->addContent($oRecord, "Page 1");
 ...
 * Viene innestato l'oggetto $oRecord all'interno della pagina
 */
$cm->oPage->addContent($oRecord, "Page 2");
 ...
 * Viene innestato l'oggetto $oRecord all'interno della pagina
 */
$cm->oPage->addContent($oRecord, "Page 3");
 ...
 * Viene innestato l'oggetto $oRecord all'interno della pagina
 */
$cm->oPage->addContent($oRecord, "Page 4");
