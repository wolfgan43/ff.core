...
$form_wrap = $cm->oPage->frameworkCSS->get("wrap", "form");
/**
 * Campi di base
 */
$group_field = "base";
...
/******************************************************************************************/
$oRecord->addContent('<h2 class="' . $cm->oPage->frameworkCSS->get(array(12), "col") . '">Campo Semplice</h2>', $group_field);
$oRecord->addContent('<div class="' . $form_wrap . '">', $group_field);
...
$oRecord->addContent('<hr /><h2 class="' . $cm->oPage->frameworkCSS->get(array(12), "col") . '">Tipi di dato</h2>', $group_field);
...
$oRecord->addContent('<hr /><h2 class="' . $cm->oPage->frameworkCSS->get(array(12), "col") . '">Campo di selezione (Selection)</h2>', $group_field);
 ...
 */
$oField->source_SQL = "  SELECT ID, username FROM " . $dbStruct["table"]["name"] . "
                          WHERE 1 
...
$code = '<div class="' . $cm->oPage->frameworkCSS->get(array(6), "col") . '">
	<code>
         ...
         */ <br />
        $oField->source_SQL = "  SELECT ID, username FROM ' . $dbStruct["table"]["name"] . ' <br />
                                  WHERE 1 <br />
...
$oRecord->addContent('<hr /><h2 class="' . $cm->oPage->frameworkCSS->get(array(12), "col") . '">Widgets</h2>', $group_field);
...
$code = '<div class="' . $cm->oPage->frameworkCSS->get(array(6), "col") . '">
	<code>
        ...
        $oField->source_SQL = "SELECT ID<br />
                                , username<br />
                            FROM ' . $dbStruct["table"]["name"] . '<br />
                            WHERE 1<br />
...
$oField->autocomplete_compare = "CONCAT(username, ' (', email, ')')";
$oField->autocomplete_operation = "LIKE [%[VALUE]%]";
$oField->source_SQL = "SELECT ID
                          , CONCAT(username, ' (', email, ')') AS name_surname
                        FROM " . $dbStruct["table"]["name"] . "
                        WHERE 1
                        [AND][WHERE][HAVING]
...
$code = '<div class="' . $cm->oPage->frameworkCSS->get(array(6), "col") . '">
	<code>
        ...
        $oField->autocomplete_compare = "CONCAT(username, \' (\', email, \')\')";<br />
        $oField->autocomplete_operation = "LIKE [%[VALUE]%]";<br />
        $oField->source_SQL = "SELECT ID<br />
                                  , CONCAT(username, \' (\', email, \')\') AS name_surname<br />
                                FROM ' . $dbStruct["table"]["name"] . '<br />
                                WHERE 1<br />
                                [AND][WHERE][HAVING]<br />
