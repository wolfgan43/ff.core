 ...
 */
//$oGrid->id = "Users-basic";
$oGrid->full_ajax = true;
$oGrid->type = "basic";
$oGrid->title = "Basic Example";
$oGrid->description = "For basic styling—light padding and only horizontal dividers—add the base class <code>.table</code> to any";
$oGrid->framework_css["component"]["header_wrap"] = false;
//$oGrid->strError = "sono un errore di prova";
/**
 ...
 * ID della griglia, deve essere univoco nella pagina
 */
//$oGrid->id = "Users-inverse";
$oGrid->full_ajax = true;
$oGrid->type = "inverse";
$oGrid->title = "Inverse Table";
$oGrid->description = "You can also invert the colors—with light text on dark backgrounds—with <code>.table-dark</code>.";
$oGrid->framework_css["component"]["header_wrap"] = false;
 ...
 * ID della griglia, deve essere univoco nella pagina
 */
//$oGrid->id = "Users-striped";
$oGrid->full_ajax = true;
$oGrid->type = "oddeven";
$oGrid->title = "Stripped Rows";
$oGrid->description = "Use <code>.table-striped</code> to add zebra-striping to any table row.";
$oGrid->framework_css["component"]["header_wrap"] = false;
//$oGrid->strError = "sono un errore di prova";
/**
 * La query utilizzata per recuperare i dati da visualizzare.
 ...
 * ID della griglia, deve essere univoco nella pagina
 */
//$oGrid->id = "Users-bordered";
$oGrid->full_ajax = true;
$oGrid->type = "border";
$oGrid->title = "Bordered Rows";
$oGrid->description = "Add <code>.table-bordered</code> for borders on all sides of the table and cells.";
$oGrid->framework_css["component"]["header_wrap"] = false;
 ...
 * ID della griglia, deve essere univoco nella pagina
 */
//$oGrid->id = "Users-hoverable";
$oGrid->full_ajax = true;
$oGrid->type = "hover";
$oGrid->title = "Hoverable Rows";
$oGrid->description = "Add <code>.table-hover</code> to enable a hover state on table rows.";
$oGrid->framework_css["component"]["header_wrap"] = false;
//$oGrid->title = "Data Table";
//$oGrid->description = "Sono una descrizione di prova";
//$oGrid->strError = "sono un errore di prova";
 ...
 * ID della griglia, deve essere univoco nella pagina
 */
//$oGrid->id = "Users-small";
$oGrid->full_ajax = true;
$oGrid->type = "small";
$oGrid->title = "Small Rows";
$oGrid->description = "Add <code>.table-sm</code> to make tables more compact by cutting cell padding in half.";
$oGrid->framework_css["component"]["header_wrap"] = false;
//$oGrid->title = "Data Table";
//$oGrid->description = "Sono una descrizione di prova";
//$oGrid->strError = "sono un errore di prova";
 ...
 * ID della griglia, deve essere univoco nella pagina
 */
//$oGrid->id = "Users-responsive";
$oGrid->full_ajax = true;
$oGrid->title = "Always Responsive";
$oGrid->description = "Across every breakpoint, use <code>.table-responsive</code> for horizontally scrolling tables. Use <code>.table-responsive{-sm|-md|-lg|-xl}</code> as needed to create responsive tables up to a particular breakpoint. From that breakpoint and up, the table will behave normally and not scroll horizontally.";
$oGrid->framework_css["component"]["header_wrap"] = false;
//$oGrid->strError = "sono un errore di prova";
/**
 * La query utilizzata per recuperare i dati da visualizzare.
