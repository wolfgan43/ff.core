...
$oGrid->title = "Data Table Draggable";
...
/*$oGrid->widget_deps[] = array(
    ...
    , "options" => array(
        &$oGrid
        , array(
            "resource_id" => "labelsort"
            , "service_path" => $cm->oPage->page_path . "/data_tables/sort"
        )
    )
);*/
...
$oButton->url = $cm->oPage->site_path . $cm->oPage->page_path . $cm->real_path_info . "/modify?keys[ID]=" . $_REQUEST["keys"]["ID"];
