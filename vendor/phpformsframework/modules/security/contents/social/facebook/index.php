...
*/
	...
	*/
	...
	if($username) {
		//$tpl->set_var("username_class", $cm->oPage->frameworkCSS->getClass($framework_css["logout"]["account"]["username"]));
		$tpl->set_var("username", $username);
		$tpl->parse("SectUsername", false);
	}
	if($email) {
		//$tpl->set_var("email_class", $cm->oPage->frameworkCSS->getClass($framework_css["logout"]["account"]["email"]));
    ...
    $tpl->set_var("login_button_class", $cm->oPage->frameworkCSS->getClass($framework_css["actions"]["login"]["def"]));
