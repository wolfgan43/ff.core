...
define("FF_ENV_DEVELOPMENT", "www.xoduslab.com");
...
switch (true)
{
	case ($_SERVER["HTTP_HOST"] == FF_ENV_DEVELOPMENT):
		// PATH SETTINGS
		define("FF_DISK_PATH", "/home/xoduslab/public_html/dev");
		define("FF_SITE_PATH", "/dev");

		// DEFAULT DB CONNECTION FOR ffDb_Sql
		define("FF_DATABASE_HOST", "localhost");
		define("FF_DATABASE_NAME", "xoduslab_stable2018-beta");
		define("FF_DATABASE_USER", "xoduslab_admin");
		define("FF_DATABASE_PASSWORD", "SAfx-FuWLS1P");
...
define("APPID", "asdf3qaweqfasd");
if(APPID == "not_set"){
    die("Modifica l'APPID in config.php");
}

// session name
session_name("alhvbsasqwedq457h");
