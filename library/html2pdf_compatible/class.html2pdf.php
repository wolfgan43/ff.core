...
if (!defined('__CLASS_HTML2PDF__')) {
    ...
    class HTML2PDF
    {
        ...
        public function getHtmlFromPage($html)
        {
			...
			// BEGIN mod by samuele.diella@gmail.com
			$close_page = false;
			if (strpos($res[1], "<page>") !== false)
			{
				// ignore body attrs when page already used inside
				$res[1] = substr($res[1], strpos($res[1], ">") + 1);
				$content = $res[1];
			}
			else
			{
			...
			// END mod by samuele.diella@gmail.com
