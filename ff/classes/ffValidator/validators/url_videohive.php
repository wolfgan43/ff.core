 ...
 * @link http://www.formsphpframework.com
 */
class ffValidator_url_videohive extends ffValidator_base
{
	...
	public function checkValue(ffData $value, $label, $options)
	{
        ...
        if((strpos($url, "videohive")||strpos($url, "youtube")) === false) {
            return "L'url inserito nel campo \"$label\" non è un video VideoHive o YouTube";
        }
