...
$FormsLocale_MSSQL_format = array(
	  "Number" 		=> ""
	, "DateTime" 	=> ""
	, "Time" 		=> ""
	, "Date" 		=> ""
...
function FormsLocale_MSSQL_SetDateTime($oFormsData, $value)
	{
		...
		FormsLocale_MSSQL_NormalizeDate($oFormsData);
	}

function FormsLocale_MSSQL_SetDate($oFormsData, $value)
	{
...
function FormsLocale_MSSQL_SetTime($oFormsData, $value)
	{
...
function FormsLocale_MSSQL_NormalizeDate($oFormsData)
	{
...
function FormsLocale_MSSQL_GetDateTime($oFormsData)
	{
		return $oFormsData[0]->value_date_day . "/" . $oFormsData[0]->value_date_month . "/" . $oFormsData[0]->value_date_year . " " .
				$oFormsData[0]->value_date_hours . ":" . $oFormsData[0]->value_date_minutes . ":" . $oFormsData[0]->value_date_seconds;
	}

function FormsLocale_MSSQL_GetDate($oFormsData)
	{
...
function FormsLocale_MSSQL_GetTime($oFormsData)
	{
		return $oFormsData[0]->value_date_hours . ":" . $oFormsData[0]->value_date_minutes /*. ":" . $oFormsData[0]->value_date_seconds*/;
	}

function FormsLocale_MSSQL_SetCurrency($oFormsData, $value)
	{
...
function FormsLocale_MSSQL_GetCurrency($oFormsData)
	{
...
function FormsLocale_MSSQL_SetNumber($oFormsData, $value)
	{
		$oFormsData[0]->value_text = $value;

		preg_match_all("/(\-){0,1}(\d+)(\.(\d+)){0,1}/", $value, $matches);
...
function FormsLocale_MSSQL_GetNumber($oFormsData)
	{
...
function FormsLocale_MSSQL_GetTimestamp($oFormsData)
{
...
function FormsLocale_MSSQL_SetTimestamp($oFormsData, $value)
{
...
function FormsLocale_MSSQL_GetTimeToSec($oFormsData)
{        
...
function FormsLocale_MSSQL_SetTimeToSec($oFormsData, $value)
{
	if(is_numeric($value) && $value > 0)
	{
