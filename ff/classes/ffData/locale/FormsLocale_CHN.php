...
function FormsLocale_CHN_SetDateTime($oFormsData, $value)
	{
		...
		FormsLocale_CHN_NormalizeDate($oFormsData);
	}

function FormsLocale_CHN_SetDate($oFormsData, $value)
	{
...
function FormsLocale_CHN_SetTime($oFormsData, $value)
	{
...
function FormsLocale_CHN_NormalizeDate($oFormsData)
	{
...
function FormsLocale_CHN_GetDateTime($oFormsData)
	{
...
function FormsLocale_CHN_GetDate($oFormsData)
	{
		if ($oFormsData[0]->value_date_year == 0 || $oFormsData[0]->value_date_month == 0 || $oFormsData[0]->value_date_day == 0
            || !strlen($oFormsData[0]->ori_value))
			return "";
...
function FormsLocale_CHN_GetCurrency($oFormsData)
	{
...
function FormsLocale_CHN_SetNumber($oFormsData, $value)
	{
		$oFormsData[0]->value_text = $value;
...
function FormsLocale_CHN_GetNumber($oFormsData)
	{
...
function FormsLocale_CHN_GetTimestamp($oFormsData)
{
...
function FormsLocale_CHN_SetTimestamp($oFormsData, $value)
{
...
function FormsLocale_CHN_GetTimeToSec($oFormsData)
{        
...
function FormsLocale_CHN_SetTimeToSec($oFormsData, $value)
{
	if(is_numeric($value) && $value > 0)
	{
...
function FormsLocale_CHN_CheckTime($raw_value)
{
...
function FormsLocale_CHN_CheckDate($raw_value)
{
...
function FormsLocale_CHN_CheckDateTime($raw_value)
{
...
function FormsLocale_CHN_CheckCurrency($raw_value)
{
...
function FormsLocale_CHN_CheckNumber($raw_value)
{
