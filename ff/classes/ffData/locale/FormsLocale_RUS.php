...
function FormsLocale_RUS_SetDateTime($oFormsData, $value)
	{
		...
		FormsLocale_RUS_NormalizeDate($oFormsData);
	}

function FormsLocale_RUS_SetDate($oFormsData, $value)
	{
...
function FormsLocale_RUS_SetTime($oFormsData, $value)
	{
...
function FormsLocale_RUS_NormalizeDate($oFormsData)
	{
...
function FormsLocale_RUS_GetDateTime($oFormsData)
	{
...
function FormsLocale_RUS_GetDate($oFormsData)
	{
		if ($oFormsData[0]->value_date_year == 0 || $oFormsData[0]->value_date_month == 0 || $oFormsData[0]->value_date_day == 0
            || !strlen($oFormsData[0]->ori_value))
			return "";
...
function FormsLocale_RUS_GetCurrency($oFormsData)
	{
...
function FormsLocale_RUS_SetNumber($oFormsData, $value)
	{
		$oFormsData[0]->value_text = $value;
...
function FormsLocale_RUS_GetNumber($oFormsData)
	{
...
function FormsLocale_RUS_GetTimestamp($oFormsData)
{
...
function FormsLocale_RUS_SetTimestamp($oFormsData, $value)
{
...
function FormsLocale_RUS_GetTimeToSec($oFormsData)
{        
...
function FormsLocale_RUS_SetTimeToSec($oFormsData, $value)
{
	if(is_numeric($value) && $value > 0)
	{
...
function FormsLocale_RUS_CheckTime($raw_value)
{
...
function FormsLocale_RUS_CheckDate($raw_value)
{
...
function FormsLocale_RUS_CheckDateTime($raw_value)
{
...
function FormsLocale_RUS_CheckCurrency($raw_value)
{
...
function FormsLocale_RUS_CheckNumber($raw_value)
{
