...
function FormsLocale_JPN_SetDateTime($oFormsData, $value)
	{
		...
		FormsLocale_JPN_NormalizeDate($oFormsData);
	}

function FormsLocale_JPN_SetDate($oFormsData, $value)
	{
...
function FormsLocale_JPN_SetTime($oFormsData, $value)
	{
...
function FormsLocale_JPN_NormalizeDate($oFormsData)
	{
...
function FormsLocale_JPN_GetDateTime($oFormsData)
	{
...
function FormsLocale_JPN_GetDate($oFormsData)
	{
		if ($oFormsData[0]->value_date_year == 0 || $oFormsData[0]->value_date_month == 0 || $oFormsData[0]->value_date_day == 0
            || !strlen($oFormsData[0]->ori_value))
			return "";
...
function FormsLocale_JPN_GetCurrency($oFormsData)
	{
...
function FormsLocale_JPN_SetNumber($oFormsData, $value)
	{
		$oFormsData[0]->value_text = $value;
...
function FormsLocale_JPN_GetNumber($oFormsData)
	{
...
function FormsLocale_JPN_GetTimestamp($oFormsData)
{
...
function FormsLocale_JPN_SetTimestamp($oFormsData, $value)
{
...
function FormsLocale_JPN_GetTimeToSec($oFormsData)
{        
...
function FormsLocale_JPN_SetTimeToSec($oFormsData, $value)
{
	if(is_numeric($value) && $value > 0)
	{
...
function FormsLocale_JPN_CheckTime($raw_value)
{
...
function FormsLocale_JPN_CheckDate($raw_value)
{
...
function FormsLocale_JPN_CheckDateTime($raw_value)
{
...
function FormsLocale_JPN_CheckCurrency($raw_value)
{
...
function FormsLocale_JPN_CheckNumber($raw_value)
{
