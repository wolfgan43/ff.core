...
function FormsLocale_POR_SetDateTime($oFormsData, $value)
	{
		...
		FormsLocale_POR_NormalizeDate($oFormsData);
	}

function FormsLocale_POR_SetDate($oFormsData, $value)
	{
...
function FormsLocale_POR_SetTime($oFormsData, $value)
	{
...
function FormsLocale_POR_NormalizeDate($oFormsData)
	{
...
function FormsLocale_POR_GetDateTime($oFormsData)
	{
...
function FormsLocale_POR_GetDate($oFormsData)
	{
		if ($oFormsData[0]->value_date_year == 0 || $oFormsData[0]->value_date_month == 0 || $oFormsData[0]->value_date_day == 0
            || !strlen($oFormsData[0]->ori_value))
			return "";
...
function FormsLocale_POR_GetCurrency($oFormsData)
	{
...
function FormsLocale_POR_SetNumber($oFormsData, $value)
	{
		$oFormsData[0]->value_text = $value;
...
function FormsLocale_POR_GetNumber($oFormsData)
	{
...
function FormsLocale_POR_GetTimestamp($oFormsData)
{
...
function FormsLocale_POR_SetTimestamp($oFormsData, $value)
{
...
function FormsLocale_POR_GetTimeToSec($oFormsData)
{        
...
function FormsLocale_POR_SetTimeToSec($oFormsData, $value)
{
	if(is_numeric($value) && $value > 0)
	{
...
function FormsLocale_POR_CheckTime($raw_value)
{
...
function FormsLocale_POR_CheckDate($raw_value)
{
...
function FormsLocale_POR_CheckDateTime($raw_value)
{
...
function FormsLocale_POR_CheckCurrency($raw_value)
{
...
function FormsLocale_POR_CheckNumber($raw_value)
{
