...
function FormsLocale_FRA_SetDateTime($oFormsData, $value)
	{
		...
		FormsLocale_FRA_NormalizeDate($oFormsData);
	}

function FormsLocale_FRA_SetDate($oFormsData, $value)
	{
...
function FormsLocale_FRA_SetTime($oFormsData, $value)
	{
...
function FormsLocale_FRA_NormalizeDate($oFormsData)
	{
...
function FormsLocale_FRA_GetDateTime($oFormsData)
	{
...
function FormsLocale_FRA_GetDate($oFormsData)
	{
		if ($oFormsData[0]->value_date_year == 0 || $oFormsData[0]->value_date_month == 0 || $oFormsData[0]->value_date_day == 0
            || !strlen($oFormsData[0]->ori_value))
			return "";
...
function FormsLocale_FRA_GetCurrency($oFormsData)
	{
...
function FormsLocale_FRA_SetNumber($oFormsData, $value)
	{
		$oFormsData[0]->value_text = $value;
...
function FormsLocale_FRA_GetNumber($oFormsData)
	{
...
function FormsLocale_FRA_GetTimestamp($oFormsData)
{
...
function FormsLocale_FRA_SetTimestamp($oFormsData, $value)
{
...
function FormsLocale_FRA_GetTimeToSec($oFormsData)
{        
...
function FormsLocale_FRA_SetTimeToSec($oFormsData, $value)
{
	if(is_numeric($value) && $value > 0)
	{
...
function FormsLocale_FRA_CheckTime($raw_value)
{
...
function FormsLocale_FRA_CheckDate($raw_value)
{
...
function FormsLocale_FRA_CheckDateTime($raw_value)
{
...
function FormsLocale_FRA_CheckCurrency($raw_value)
{
...
function FormsLocale_FRA_CheckNumber($raw_value)
{
