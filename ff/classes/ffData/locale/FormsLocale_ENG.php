...
function FormsLocale_ENG_SetDateTime($oFormsData, $value)
	{
		preg_match_all("/((\d+):(\d+)(:(\d+))*\s+(\d+)[-\/](\d+)[-\/](\d+))|((\d+)[-\/](\d+)[-\/](\d+)\s+(\d+):(\d+)(:(\d+))*)/", $value, $matches);
		$oFormsData[0]->value_date_day = $matches[7][0] ? $matches[7][0] : $matches[11][0];
		$oFormsData[0]->value_date_month = $matches[6][0] ? $matches[6][0] : $matches[10][0];
...
function FormsLocale_ENG_SetDate($oFormsData, $value)
	{
		...
		$oFormsData[0]->value_date_day = $matches[2][0];
		$oFormsData[0]->value_date_month = $matches[1][0];
		$oFormsData[0]->value_date_year = $matches[3][0];

		FormsLocale_ENG_NormalizeDate($oFormsData);
	}

function FormsLocale_ENG_SetTime($oFormsData, $value)
	{
...
function FormsLocale_ENG_GetDateTime($oFormsData)
	{
		if ($oFormsData[0]->value_date_year == 0 || $oFormsData[0]->value_date_month == 0 || $oFormsData[0]->value_date_day == 0
		    ...
		    return  sprintf("%02d", intval($oFormsData[0]->value_date_month)) . "/" . sprintf("%02d", intval($oFormsData[0]->value_date_day)) . "/" . sprintf("%04d", intval($oFormsData[0]->value_date_year)) .
...
function FormsLocale_ENG_GetDate($oFormsData)
	{
		if ($oFormsData[0]->value_date_year == 0 || $oFormsData[0]->value_date_month == 0 || $oFormsData[0]->value_date_day == 0
            || !strlen($oFormsData[0]->ori_value))
			return "";
...
function FormsLocale_ENG_GetCurrency($oFormsData)
	{
...
function FormsLocale_ENG_SetNumber($oFormsData, $value)
	{
		$oFormsData[0]->value_text = $value;
...
function FormsLocale_ENG_GetNumber($oFormsData)
	{
...
function FormsLocale_ENG_GetTimestamp($oFormsData)
{
...
function FormsLocale_ENG_SetTimestamp($oFormsData, $value)
{
...
function FormsLocale_ENG_GetTimeToSec($oFormsData)
{        
...
function FormsLocale_ENG_SetTimeToSec($oFormsData, $value)
{
	if(is_numeric($value) && $value > 0)
	{
...
function FormsLocale_ENG_CheckTime($raw_value)
{
...
function FormsLocale_ENG_CheckDate($raw_value)
{
...
function FormsLocale_ENG_CheckDateTime($raw_value)
{
...
function FormsLocale_ENG_CheckCurrency($raw_value)
{
...
function FormsLocale_ENG_CheckNumber($raw_value)
{
