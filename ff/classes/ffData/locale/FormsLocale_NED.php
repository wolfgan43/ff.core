...
function FormsLocale_NED_SetDateTime($oFormsData, $value)
	{
		...
		FormsLocale_NED_NormalizeDate($oFormsData);
	}

function FormsLocale_NED_SetDate($oFormsData, $value)
	{
...
function FormsLocale_NED_SetTime($oFormsData, $value)
	{
...
function FormsLocale_NED_NormalizeDate($oFormsData)
	{
...
function FormsLocale_NED_GetDateTime($oFormsData)
	{
...
function FormsLocale_NED_GetDate($oFormsData)
	{
		if ($oFormsData[0]->value_date_year == 0 || $oFormsData[0]->value_date_month == 0 || $oFormsData[0]->value_date_day == 0
            || !strlen($oFormsData[0]->ori_value))
			return "";
...
function FormsLocale_NED_GetCurrency($oFormsData)
	{
...
function FormsLocale_NED_SetNumber($oFormsData, $value)
	{
		$oFormsData[0]->value_text = $value;
...
function FormsLocale_NED_GetNumber($oFormsData)
	{
...
function FormsLocale_NED_GetTimestamp($oFormsData)
{
...
function FormsLocale_NED_SetTimestamp($oFormsData, $value)
{
...
function FormsLocale_NED_GetTimeToSec($oFormsData)
{        
...
function FormsLocale_NED_SetTimeToSec($oFormsData, $value)
{
	if(is_numeric($value) && $value > 0)
	{
...
function FormsLocale_NED_CheckTime($raw_value)
{
...
function FormsLocale_NED_CheckDate($raw_value)
{
...
function FormsLocale_NED_CheckDateTime($raw_value)
{
...
function FormsLocale_NED_CheckCurrency($raw_value)
{
...
function FormsLocale_NED_CheckNumber($raw_value)
{
