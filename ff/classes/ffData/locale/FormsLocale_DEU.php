...
function FormsLocale_DEU_SetDateTime($oFormsData, $value)
	{
		...
		FormsLocale_DEU_NormalizeDate($oFormsData);
	}

function FormsLocale_DEU_SetDate($oFormsData, $value)
	{
...
function FormsLocale_DEU_SetTime($oFormsData, $value)
	{
...
function FormsLocale_DEU_NormalizeDate($oFormsData)
	{
...
function FormsLocale_DEU_GetDateTime($oFormsData)
	{
...
function FormsLocale_DEU_GetDate($oFormsData)
	{
		if ($oFormsData[0]->value_date_year == 0 || $oFormsData[0]->value_date_month == 0 || $oFormsData[0]->value_date_day == 0
            || !strlen($oFormsData[0]->ori_value))
			return "";
...
function FormsLocale_DEU_GetCurrency($oFormsData)
	{
...
function FormsLocale_DEU_SetNumber($oFormsData, $value)
	{
		$oFormsData[0]->value_text = $value;
...
function FormsLocale_DEU_GetNumber($oFormsData)
	{
...
function FormsLocale_DEU_GetTimestamp($oFormsData)
{
...
function FormsLocale_DEU_SetTimestamp($oFormsData, $value)
{
...
function FormsLocale_DEU_GetTimeToSec($oFormsData)
{        
...
function FormsLocale_DEU_SetTimeToSec($oFormsData, $value)
{
	if(is_numeric($value) && $value > 0)
	{
...
function FormsLocale_DEU_CheckTime($raw_value)
{
...
function FormsLocale_DEU_CheckDate($raw_value)
{
...
function FormsLocale_DEU_CheckDateTime($raw_value)
{
...
function FormsLocale_DEU_CheckCurrency($raw_value)
{
...
function FormsLocale_DEU_CheckNumber($raw_value)
{
