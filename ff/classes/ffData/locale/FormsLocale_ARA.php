...
function FormsLocale_ARA_SetDateTime($oFormsData, $value)
	{
		...
		FormsLocale_ARA_NormalizeDate($oFormsData);
	}

function FormsLocale_ARA_SetDate($oFormsData, $value)
	{
...
function FormsLocale_ARA_SetTime($oFormsData, $value)
	{
...
function FormsLocale_ARA_NormalizeDate($oFormsData)
	{
...
function FormsLocale_ARA_GetDateTime($oFormsData)
	{
...
function FormsLocale_ARA_GetDate($oFormsData)
	{
		if ($oFormsData[0]->value_date_year == 0 || $oFormsData[0]->value_date_month == 0 || $oFormsData[0]->value_date_day == 0
            || !strlen($oFormsData[0]->ori_value))
			return "";
...
function FormsLocale_ARA_GetCurrency($oFormsData)
	{
...
function FormsLocale_ARA_SetNumber($oFormsData, $value)
	{
		$oFormsData[0]->value_text = $value;
...
function FormsLocale_ARA_GetNumber($oFormsData)
	{
...
function FormsLocale_ARA_GetTimestamp($oFormsData)
	{
...
function FormsLocale_ARA_SetTimestamp($oFormsData, $value)
	{
...
function FormsLocale_ARA_GetTimeToSec($oFormsData)
{        
...
function FormsLocale_ARA_SetTimeToSec($oFormsData, $value)
{
	if(is_numeric($value) && $value > 0)
	{
...
function FormsLocale_ARA_CheckTime($raw_value)
{
...
function FormsLocale_ARA_CheckDate($raw_value)
{
...
function FormsLocale_ARA_CheckDateTime($raw_value)
{
...
function FormsLocale_ARA_CheckCurrency($raw_value)
{
...
function FormsLocale_ARA_CheckNumber($raw_value)
{
