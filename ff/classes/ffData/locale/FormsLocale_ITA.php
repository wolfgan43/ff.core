...
function FormsLocale_ITA_SetDateTime($oFormsData, $value)
{
	...
	FormsLocale_ITA_NormalizeDate($oFormsData);
}

function FormsLocale_ITA_SetDate($oFormsData, $value)
{
...
function FormsLocale_ITA_SetTime($oFormsData, $value)
{
...
function FormsLocale_ITA_NormalizeDate($oFormsData)
{
...
function FormsLocale_ITA_GetDateTime($oFormsData)
{
...
function FormsLocale_ITA_GetDate($oFormsData)
{
	if ($oFormsData[0]->value_date_year == 0 || $oFormsData[0]->value_date_month == 0 || $oFormsData[0]->value_date_day == 0
		|| !strlen($oFormsData[0]->ori_value))
		return "";
...
function FormsLocale_ITA_GetTime($oFormsData)
	{
		if (!strlen($oFormsData[0]->ori_value))
			return "";
        else
		    return sprintf("%02d", intval($oFormsData[0]->value_date_hours)) . ":" . sprintf("%02d", intval($oFormsData[0]->value_date_minutes)) /*. ":" . $oFormsData[0]->value_date_seconds*/;
	}

function FormsLocale_ITA_SetCurrency($oFormsData, $value)
{
...
function FormsLocale_ITA_SetExtCurrency($oFormsData, $value)
{
	$oFormsData[0]->value_text = $value;
...
function FormsLocale_ITA_GetCurrency($oFormsData)
{
	if (!strlen($oFormsData[0]->value_text))
		return;
...
function FormsLocale_ITA_SetExtNumber($oFormsData, $value)
{
	$oFormsData[0]->value_text = $value;
...
function FormsLocale_ITA_GetNumber($oFormsData)
{
	if ($oFormsData[0]->value_sign)
		$sign = -1;
	else
...
function FormsLocale_ITA_GetExtNumber($oFormsData)
{
	if ($oFormsData[0]->value_sign)
		$sign = -1;
	else
...
function FormsLocale_ITA_GetTimestamp($oFormsData)
{
...
function FormsLocale_ITA_SetTimestamp($oFormsData, $value)
{ 
...
function FormsLocale_ITA_GetTimeToSec($oFormsData)
{        
...
function FormsLocale_ITA_SetTimeToSec($oFormsData, $value)
{
	if(is_numeric($value) && $value > 0)
	{
...
function FormsLocale_ITA_CheckTime($raw_value)
{
...
function FormsLocale_ITA_CheckDate($raw_value)
{
...
function FormsLocale_ITA_CheckDateTime($raw_value)
{
...
function FormsLocale_ITA_CheckCurrency($raw_value)
{
...
function FormsLocale_ITA_CheckExtCurrency($raw_value)
{
...
function FormsLocale_ITA_CheckNumber($raw_value)
{
...
function FormsLocale_ITA_CheckExtNumber($raw_value)
{
     if (!preg_match("/^\\s*\\-{0,1}\\s*\\d+\\s*(\\,\\s*\\d+){0,1}\\s*$/", $raw_value))
        return FALSE;
    else
