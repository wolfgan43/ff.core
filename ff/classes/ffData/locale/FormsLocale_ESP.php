...
function FormsLocale_ESP_SetDateTime($oFormsData, $value)
	{
		...
		FormsLocale_ESP_NormalizeDate($oFormsData);
	}

function FormsLocale_ESP_SetDate($oFormsData, $value)
	{
...
function FormsLocale_ESP_SetTime($oFormsData, $value)
	{
...
function FormsLocale_ESP_NormalizeDate($oFormsData)
	{
...
function FormsLocale_ESP_GetDateTime($oFormsData)
	{
...
function FormsLocale_ESP_GetDate($oFormsData)
	{
		if ($oFormsData[0]->value_date_year == 0 || $oFormsData[0]->value_date_month == 0 || $oFormsData[0]->value_date_day == 0
            || !strlen($oFormsData[0]->ori_value))
			return "";
...
function FormsLocale_ESP_GetCurrency($oFormsData)
	{
...
function FormsLocale_ESP_SetNumber($oFormsData, $value)
	{
		$oFormsData[0]->value_text = $value;
...
function FormsLocale_ESP_GetNumber($oFormsData)
	{
...
function FormsLocale_ESP_GetTimestamp($oFormsData)
{
...
function FormsLocale_ESP_SetTimestamp($oFormsData, $value)
{
...
function FormsLocale_ESP_GetTimeToSec($oFormsData)
{        
...
function FormsLocale_ESP_SetTimeToSec($oFormsData, $value)
{
	if(is_numeric($value) && $value > 0)
	{
...
function FormsLocale_ESP_CheckTime($raw_value)
{
...
function FormsLocale_ESP_CheckDate($raw_value)
{
...
function FormsLocale_ESP_CheckDateTime($raw_value)
{
...
function FormsLocale_ESP_CheckCurrency($raw_value)
{
...
function FormsLocale_ESP_CheckNumber($raw_value)
{
