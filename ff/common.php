...
{
    //ffErrorHandler::raise("DIALOG", E_USER_ERROR, null, get_defined_vars());
    $url = $dlg_site_path;
...
function ffCommon_specialchars($string, $quote_style = ENT_QUOTES, $charset = null, $double_encode = true)
{
    if ($charset === null)
        $charset = FF_DEFAULT_CHARSET;
