...
"init" : function (params) {
	...
	//	jQuery(this).children("td:first:not(.norec_cont)").css("background", "url(" + ff.site_path + "/themes/restricted/ff/ffGrid/widgets/dragsort/grippy.png) 4px no-repeat").css("padding", "0 0 0 14px");
	//});
},

"reorder" : function (id) {
	var params = that.inst.get(id);
	var $table = jQuery(".ffGrid", jQuery("#" + id));
