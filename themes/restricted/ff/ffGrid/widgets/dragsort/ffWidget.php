...
class ffWidget_dragsort extends ffCommon
{
	...
	function get_component_headers($id)
	{
		if ($this->oPage !== NULL) { //code for ff.js
			$this->oPage[0]->tplAddCss("ff.ffGrid.dragsort", "ff.ffGrid.dragsort.css", FF_THEME_DIR . "/restricted/ff/ffGrid/widgets/dragsort");
			$this->oPage[0]->tplAddJs("jquery.fn.jTableOrder", "jTableOrder.js", FF_THEME_DIR . "/restricted/ff/ffGrid/widgets/dragsort");
			$this->oPage[0]->tplAddJs("ff.ffGrid", "ffGrid.js", FF_THEME_DIR . "/library/ff");
            $this->oPage[0]->tplAddJs("ff.ffGrid.dragsort", "dragsort.js", FF_THEME_DIR . "/restricted/ff/ffGrid/widgets/dragsort");
		}
