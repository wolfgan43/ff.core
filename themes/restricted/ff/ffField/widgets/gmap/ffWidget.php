...
class ffWidget_gmap
{
	...
	function process($id, &$value, ffField_base &$Field)
	{
        ...
        if(strlen($Field->widget_path))
            ...
            $this->tpl[$tpl_id]->set_var("widget_path", "/themes/restricted/ff/ffField/widgets/gmap");
	...
	function get_component_headers($id)
	{
		if ($this->oPage !== NULL) { //code for ff.js
			...
			$this->oPage[0]->tplAddJs("ff.ffField.gmap", "gmap.js", FF_THEME_DIR . "/restricted/ff/ffField/widgets/gmap");
		}
