...
var that = { /* publics*/
	...
	"init" : function(id, brmode, theme, skin, lang, toolbar, custom_config) {
		...
		config.toolbar							= "default"; /*The toolbox (alias toolbar) definition. It is a toolbar name or an array of toolbars (strips), each one being also an array, containing a list of UI items. */
...
/*			
			switch (ff.struct.get("comps").get(component).type) {
				case "ffDetails":
					...
					console.log(ff.struct.get("comps").get(component));
