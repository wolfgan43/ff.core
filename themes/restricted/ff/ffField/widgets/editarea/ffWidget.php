...
class ffWidget_editarea extends ffCommon
{
	...
	function process($id, &$value, ffField_base &$Field)
	{
		...
		//$this->tpl[$tpl_id]->strip_extra_newlines = false;
        ...
        if(strlen($Field->widget_path))
            ...
            $this->tpl[$tpl_id]->set_var("widget_path", "/themes/restricted/ff/ffField/widgets/editarea");
        ...
        if($Field->editarea_writable)
        	$this->tpl[$tpl_id]->set_var("widget_writable", "true");
        else 
        	$this->tpl[$tpl_id]->set_var("widget_writable", "false");
        	
        $this->tpl[$tpl_id]->set_var("widget_syntax", $Field->editarea_syntax);
	...
	function get_component_headers($id)
	{
		if ($this->oPage !== NULL) { //code for ff.js
			$this->oPage[0]->tplAddJs("ff.lib.editarea", "edit_area_loader.js", FF_THEME_DIR . "/library/editarea");
            $this->oPage[0]->tplAddJs("ff.ffField", "ffField.js", FF_THEME_DIR . "/library/ff");
			$this->oPage[0]->tplAddJs("ff.ffField.editarea", "editarea.js", FF_THEME_DIR . "/restricted/ff/ffField/widgets/editarea");
		}
