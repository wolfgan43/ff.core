                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="600" id="templateHeader">
                                <tr>
                                    <td class="headerContent">
                                        ...
                                        <img src="https://www.lazzarimacchine.it/themes/lazzari/images/logo/logo.png" />
                                            ...
                                            <tr>
                                                <td colspan="2" valign="middle" id="social">
                                                    <div mc:edit="std_social">
                                                        &nbsp;<a href="*|TWITTER:PROFILEURL|*">Vai al Task</a> | <a href="*|FACEBOOK:PROFILEURL|*">Chiudi il Task</a>&nbsp;
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
