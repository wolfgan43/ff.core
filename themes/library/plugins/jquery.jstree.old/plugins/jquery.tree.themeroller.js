		...
		"themeroller" : {
			...
			callbacks : {
				oninit : function (t) {
					...
					$(document).on("mouseover", "#" + this.container.attr("id") + " li a", function (e) { $(e.target).addClass("ui-state-hover"); });
					$(document).on("mouseout", "#" + this.container.attr("id") + " li a",  function (e) { $(e.target).removeClass("ui-state-hover"); });
				},
