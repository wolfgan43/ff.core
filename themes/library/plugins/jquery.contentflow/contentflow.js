...
var ContentFlowGlobal = {
    ...
    scriptElement:  (typeof contentFlowScriptElement !== "undefined" ? contentFlowScriptElement : null),
    ...
    initPath: function () {
        ...
        this.BaseDir = "/themes/library/plugins/jquery.contentflow/"; //this.getScriptPath(this.scriptElement, this.scriptName) ;
    ...
    init: function () {
        ...
        if(typeof contentFlowScriptElement === "undefined")
