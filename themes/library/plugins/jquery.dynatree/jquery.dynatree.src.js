...
//		this.tree.logDebug("dtnode.onClick(" + event.type + "): dtnode:" + this + ", button:" + event.button + ", which: " + event.which);
		...
		if( targetType == "expander" ) {
            ...
            if(this.span.getElementsByTagName("a").attr("href") != null && this.span.getElementsByTagName("a").attr("href") != "" && this.span.getElementsByTagName("a").attr("href").substring(0,1) != "#") {
            	location.href = this.span.getElementsByTagName("a").attr("href");
            	return false;
			} else {
				this.span.getElementsByTagName("a").focus();			
			}
...
//				self.logDebug("%o", title);
			...
			$li.children("a[rel]:not(:empty)").parent().addClass("folder");
			$li.children("a[rel]:not(:empty)").parent().addClass("lazy");
...
//				self.append(data);
				...
				if(self.tree.options.ajaxDefaults.dataType == "html") {
					self.createFromTag(self, $(data));
				} else {
