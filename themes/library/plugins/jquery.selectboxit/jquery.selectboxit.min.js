...
d?this.selectBox.val(this.selectItems.eq(a).val()).change():"string"===d&&this.selectBox.val(a).change();this._callbackSupport(b);return this};e.selectOption=function(a,b){var d=c.type(a);"number"===d?this.selectBox.val(this.selectItems.eq(a).val()).change():"string"===d&&this.selectBox.val(a).change();this._callbackSupport(b);return this};e.setOption=function(a,b,d){var f=this;"string"===c.type(a)&&(f.options[a]=b);f.refresh(function(){f._callbackSupport(d)},!0);return f};e.setOptions=function(a,
b){var d=this;c.isPlainObject(a)&&(d.options=c.extend({},d.options,a));d.refresh(function(){d._callbackSupport(b)},!0);return d};e.wait=function(a,b){this.widgetProto._delay.call(this,b,a);return this};e.add=function(a,b){this._populate(a,function(a){var f=this,e=c.type(a),g=0,n,l=[],k=(n=f._isJSON(a))&&f._parseJSON(a);if(a&&("array"===e||n&&k.data&&"array"===c.type(k.data))||"object"===e&&a.data&&"array"===c.type(a.data)){f._isJSON(a)&&(a=k);a.data&&(a=a.data);for(n=a.length;g<=n-1;g+=1)e=a[g],c.isPlainObject(e)?
l.push(c("<option/>",e)):"string"===c.type(e)&&l.push(c("<option/>",{text:e,value:e}));f.selectBox.append(l)}else a&&"string"===e&&!f._isJSON(a)?f.selectBox.append(a):a&&"object"===e?f.selectBox.append(c("<option/>",a)):a&&f._isJSON(a)&&c.isPlainObject(f._parseJSON(a))&&f.selectBox.append(c("<option/>",f._parseJSON(a)));f.dropdown?f.refresh(function(){f._callbackSupport(b)},!0):f._callbackSupport(b);return f})};e._parseJSON=function(a){return JSON&&JSON.parse&&JSON.parse(a)||c.parseJSON(a)};e._isJSON=
function(a){try{return this._parseJSON(a),!0}catch(b){return!1}};e._populate=function(a,b){var d=this;a=c.isFunction(a)?a.call():a;d.isDeferred(a)?a.done(function(a){b.call(d,a)}):b.call(d,a);return d};e.remove=function(a,b){var d=this,e=c.type(a),h=0,g,n="";if("array"===e){for(g=a.length;h<=g-1;h+=1)e=a[h],"number"===c.type(e)&&(n=n.length?n+(", option:eq("+e+")"):n+("option:eq("+e+")"));d.selectBox.find(n).remove()}else"number"===e?d.selectBox.find("option").eq(a).remove():d.selectBox.find("option").remove();
d.dropdown?d.refresh(function(){d._callbackSupport(b)},!0):d._callbackSupport(b);return d}});