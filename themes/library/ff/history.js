...
jQuery.extend({
	...
	historyInit: function(callback, src){
		...
		// if ((ff.browser.msie) && (ff.browser.version < 8)) {
		if (ff.browser.msie) {
...
jQuery(document).ready(function(){
	...
	jQuery.historyInit(ff.history.pageload, this.href /*"jquery_history.html"*/);
});
