...
*/
			...
			$Field->ckfinder_storing_path = ffProcessTags($Field->ckfinder_storing_path, $Field->keysarray, $Field->dataarray, "normal"); 
			$Field->ckfinder_show_file = ffProcessTags($Field->ckfinder_show_file, $Field->keysarray, $Field->dataarray, "normal"); 
	...
	function get_component_headers($id)
	{
		if ($this->oPage !== NULL) { //code for ff.js
			...
			$this->oPage[0]->tplAddJs("ff.ffField.ckuploadify", "ckuploadify.js", FF_THEME_DIR . "/default/ff/ffField/widgets/ckuploadify");
		}
